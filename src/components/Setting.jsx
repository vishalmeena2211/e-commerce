                    ...
                    <form action="#">
                      <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                        <div className="w-full sm:w-1/2">
                          <label className="mb-3 block text-sm font-medium text-black dark:text-black" for="fullName">Full
                            Name</label>
                          <div className="relative">
                            ...
                            <input
                              className="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-black dark:focus:border-primary"
                        ...
                        <div className="w-full sm:w-1/2">
                          ...
                          <input
                            className="w-full rounded border border-stroke bg-gray py-3 px-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-black dark:focus:border-primary"
                  ...
                  <div className="p-7">
                    <form action="#">
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <div>
                          <span className="mb-1.5 font-medium text-black dark:text-black">Edit your photo</span>
...
//       <h2 className="text-gray-700 text-lg">Account</h2>
//       <div className="setting__row flex items-center">
...
//   return (
//     <div className="setting">
//       <h2 className="text-gray-700 text-lg">Other</h2>
//       <div className="setting__row flex items-center">
